...
p1 <- readRDS("plots/stat_1d_by_reftyp-boxplot,n,ks.rds")
p2 <- readRDS("plots/stat_1d_by_method-boxplot,ks.rds")
...
fnm <- "stat_1d-boxplots.pdf"
fnm <- file.path("figures", fnm)
ggsave(fnm, fig, width = 16, height = 9, units = "cm")
